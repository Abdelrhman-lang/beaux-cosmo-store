...
export default function BreadCramp() {
  ...
  return (
    <nav
      ...
      className="bg-[#F2F3F5] py-2 px-5 lg:px-0 flex items-center justify-center h-[150px] mt-7"
    >
      <div className="flex flex-col gap-3 items-center">
        <h3 className="text-3xl text-secondary uppercase text-center">
          {pathname.includes("/cart") ? "your shopping cart" : ""}
        </h3>
        <ol className="flex items-center justify-center md:justify-start gap-1  text-gray-700">
          <li>
